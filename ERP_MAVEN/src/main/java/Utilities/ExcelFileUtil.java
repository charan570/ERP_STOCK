...
public class ExcelFileUtil {
	...
	{
		FileInputStream fis=new FileInputStream("D:\\Charan\\ERP_MAVEN\\TestInput\\InputSheet.xlsx");
...
return wb.getSheet(sheetname).getRow(0).getLastCellNum();		
	...
	throws Throwable{
		...
		FileOutputStream fos=new FileOutputStream("D:\\Charan\\ERP_MAVEN\\TestOutput\\maven.xlsx");
		wb.write(fos);
		fos.close();
		//wb.close();
	}
